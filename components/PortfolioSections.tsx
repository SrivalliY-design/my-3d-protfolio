      ...
      <shaderMaterial
        ...
        fragmentShader={`
          ...
          void main() {
            ...
            // Output pure color with alpha
            gl_FragColor = vec4(uColor, 0.2 + intensity * 0.8);
          }
        `}
      />
    </mesh>
...
const GlowingNode = ({ position }: { position: [number, number, number] }) => {
  ...
  useFrame((state) => {
    if (haloRef.current) {
      ...
      // Pulse opacity
      (haloRef.current.material as THREE.MeshBasicMaterial).opacity = 0.4 + Math.sin(state.clock.elapsedTime * 3) * 0.2;
    }
  });
...
export default function PortfolioSections() {
  ...
  return (
    <group>
      ...
      {nodes.map((n) => (
        <GlowingNode key={n.z} position={[n.x, 0, n.z]} />
      ))}

      {/* Objective - Node is Left (-2.5), so Card goes RIGHT */}
      <FadeHtml z={-20} align="right">
        <div className="w-80 md:w-[38rem] p-10 rounded-3xl bg-black/40 backdrop-blur-xl border border-white/10 shadow-[0_0_40px_rgba(255,122,0,0.1)] hover:shadow-[0_0_80px_rgba(255,122,0,0.4)] text-left hover:border-[#ff7a00]/80 transition-all duration-500">
      ...
      <FadeHtml z={-35} align="left">
        <div className="w-80 md:w-[42rem] p-10 rounded-3xl bg-black/40 backdrop-blur-xl border border-white/10 shadow-[0_0_40px_rgba(255,122,0,0.1)] hover:shadow-[0_0_80px_rgba(255,122,0,0.4)] text-left hover:border-[#ff7a00]/80 transition-all duration-500">
          ...
          <div className="flex flex-wrap gap-4">
            {['Core Java', 'HTML5', 'CSS3', 'MySQL', 'JavaScript', 'React.js', 'Next.js', 'Tailwind CSS'].map((skill, i) => (
              <span key={skill} className="reveal-item px-6 py-3 rounded-full bg-white/5 text-white text-base md:text-lg border border-white/10 hover:border-[#ff7a00] hover:text-[#ff7a00] transition-colors duration-300 cursor-default" style={{ transitionDelay: `${200 + i * 50}ms` }}>
                {skill}
              </span>
            ))}
          </div>
      ...
      <FadeHtml z={-50} align="right">
        <div className="w-80 md:w-[44rem] p-10 rounded-3xl bg-black/40 backdrop-blur-xl border border-white/10 shadow-[0_0_40px_rgba(255,122,0,0.1)] hover:shadow-[0_0_80px_rgba(255,122,0,0.4)] text-left hover:border-[#ff7a00]/80 transition-all duration-500">
          ...
          <div className="space-y-8 w-full">
            <div className="reveal-item delay-200 p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-[#ff7a00] transition-colors cursor-default">
            ...
            <div className="reveal-item delay-300 p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-[#ff7a00] transition-colors cursor-default">
              <h3 className="text-2xl font-bold text-white mb-2">Full stack Developer Intern</h3>
      ...
      <FadeHtml z={-65} align="left">
        <div className="w-80 md:w-[46rem] p-10 rounded-3xl bg-black/40 backdrop-blur-xl border border-white/10 shadow-[0_0_40px_rgba(255,122,0,0.1)] hover:shadow-[0_0_80px_rgba(255,122,0,0.4)] text-left hover:border-[#ff7a00]/80 transition-all duration-500">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
            <div className="reveal-item delay-200 p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-[#ff7a00] hover:-translate-y-2 transition-all duration-300 cursor-default">
              <h3 className="text-xl font-bold text-white mb-3">Online Bookstore</h3>
            ...
            <div className="reveal-item delay-300 p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-[#ff7a00] hover:-translate-y-2 transition-all duration-300 cursor-default">
              <h3 className="text-xl font-bold text-white mb-3">Colorization of Images</h3>
            ...
            <div className="reveal-item delay-400 p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-[#ff7a00] hover:-translate-y-2 transition-all duration-300 cursor-default md:col-span-2">
              <h3 className="text-xl font-bold text-white mb-3">RL For Self-driving Car</h3>
      ...
      <FadeHtml z={-80} align="center">
        <div className="w-96 md:w-[32rem] p-12 rounded-3xl bg-black/60 backdrop-blur-2xl border border-[#ff7a00]/30 shadow-[0_0_60px_rgba(255,122,0,0.2)] hover:shadow-[0_0_100px_rgba(255,122,0,0.6)] text-center flex flex-col items-center transition-all duration-500">
          ...
          <div className="reveal-item delay-100 w-16 h-1.5 bg-[#ff7a00] mb-8 rounded-full" />
          <p className="reveal-item delay-200 text-xl text-zinc-300 mb-3 font-medium">srivalli.aiml.rymec@gmail.com</p>
          <p className="reveal-item delay-300 text-xl text-zinc-400 mb-10 font-light">+91 8088393755</p>
          <div className="reveal-item delay-400 flex justify-center gap-6 w-full">
            <a href="https://github.com/SrivalliYaarlagadda" target="_blank" rel="noreferrer" className="flex-1 py-4 text-lg rounded-full bg-white text-black font-bold hover:bg-zinc-200 transition-colors pointer-events-auto text-center">
              GitHub
            </a>
            <a href="https://www.linkedin.com/in/srivalli-yaarlagadda-1000b3258" target="_blank" rel="noreferrer" className="flex-1 py-4 text-lg rounded-full bg-[#ff7a00] text-white font-bold hover:bg-[#e66e00] transition-colors shadow-[0_0_20px_rgba(255,122,0,0.4)] hover:shadow-[0_0_40px_rgba(255,122,0,0.8)] pointer-events-auto text-center">
              LinkedIn
            </a>
          </div>
        </div>
